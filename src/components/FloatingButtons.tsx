...
export default function FloatingButtons() {
  ...
  const waNumber  = "916302596477";
  const waMessage = encodeURIComponent("Hello AltarVision! I'm interested in your services.");
    ...
    <>
      ...
      >
        ...
        <span
          ...
          style={{ animation: "pulse-ring-wa 2.2s cubic-bezier(0.4,0,0.6,1) infinite", background: "rgba(37,211,102,0.3)" }}
        />
      </motion.a>
        ...
        {showTop && (
          <motion.button
            ...
            style={{
              ...
              boxShadow: "0 4px 20px rgba(91,79,207,0.2)",
            }}
          >
            <ArrowUp size={18} color="#5b4fcf" />
          </motion.button>
        )}
      </AnimatePresence>
    </>
