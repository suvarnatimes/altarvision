      ...
      >
        <div className="wrap">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            {/* Brand — responsive logo and centered mobile text */}
            <div className="lg:col-span-1 text-center lg:text-left">
              <Link href="/" className="flex items-center justify-center lg:justify-start mb-8">
                <div className="relative w-[280px] sm:w-[340px] md:w-[400px] h-[80px] sm:h-[95px] md:h-[110px] transition-opacity hover:opacity-85 duration-300">
                  <Image
              ...
              <p className="text-sm leading-relaxed mb-6 max-w-sm mx-auto lg:mx-0" style={{ color: "var(--ink-500)" }}>
            ...
            <div className="text-center lg:text-left">
              ...
              <ul className="space-y-4">
                <li className="flex flex-col lg:flex-row items-center lg:items-start gap-3 text-sm" style={{ color: "var(--ink-500)" }}>
                  <MapPin size={15} className="shrink-0 mt-0.5" style={{ color: "var(--prism-violet)" }} />
                  <span>Machilipatnam, Andhra Pradesh, India – 521001</span>
                </li>
                <li className="flex flex-col lg:flex-row items-center lg:items-start gap-3 text-sm">
